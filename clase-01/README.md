...
## Clase 1: Configuración del entorno de desarrollo
...
Al final de esta clase tenés:
- Terminal funcionando con `clang++`
- VS Code configurado con extensiones
- Tu primer programa C++ compilado y ejecutado
- Entendimiento de que compilar = convertir código en programa ejecutable
 
**En la próxima clase:** arrancamos a trabajar con señales de audio como vectores de números en C++.
